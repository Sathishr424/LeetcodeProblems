# Last updated: 8/16/2026, 12:02:52 AM
1class Solution:
...
23
24                if match != odd:
25                    new_cost += penalty[i][j]
26                else:
27                    pen_cost += penalty[i][j]
28
29                if 0 <= i2 < m and 0 <= j2 < n:
30                    if pen_cost < dis[i2][j2][odd]:
31                        heappush(heap, (pen_cost, odd, i2, j2))
32                        dis[i2][j2][odd] = pen_cost
33
